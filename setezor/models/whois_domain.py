...
class WhoIsDomain(IDDependent, Base, table=True):
    ...
    domain_id: str    = Field(foreign_key="domain.id",sa_column_kwargs={"comment": "Идентификатор domain"})

    domain: "Domain" = Relationship(back_populates="whois")