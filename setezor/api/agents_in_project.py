...
from setezor.schemas.agent import AgentAddToProject, AgentColorChange
...
async def get_agent_interfaces(
    ...
    return await agent_in_project_service.get_interfaces(project_id=project_id, agent_id=agent_id)
