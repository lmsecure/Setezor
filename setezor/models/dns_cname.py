...
class DNS_CNAME(IDDependent, Base, table=True):
    ...
    target_ip: Optional["IP"]           = Relationship(back_populates="dns_cname_target")
    target_domain: Optional["Domain"]   = Relationship(back_populates="dns_cname_target")