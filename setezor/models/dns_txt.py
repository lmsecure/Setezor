...
class DNS_TXT(IDDependent, Base, table=True):
    __tablename__ = "network_dns_txt"
    __table_args__ = {
    ...
    target_ip: Optional["IP"]           = Relationship(back_populates="dns_txt_target") # type: ignore
    target_domain: Optional["Domain"]   = Relationship(back_populates="dns_txt_target") # type: ignore