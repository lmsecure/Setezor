...
class Queries:
    ...
    def __init__(self, db_path: str):
        ...
        self.network = qf.NetworkQueries(session_maker=self.db.create_session())
        self.ip = qf.IPQueries(mac=self.mac, network=self.network, session_maker=self.db.create_session())
        ...
        self.route = qf.RouteQueries(session_maker=self.db.create_session(), ip=self.ip)
