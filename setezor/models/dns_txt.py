...
class DNS_TXT(IDDependent, Base, table=True):
    ...
    target_ip: Optional["IP"]           = Relationship(back_populates="dns_txt_target")
    target_domain: Optional["Domain"]   = Relationship(back_populates="dns_txt_target")