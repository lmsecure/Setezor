...
def add_api_routes(router: UrlDispatcher) -> None:
    ...
    """    
    for cls in [IPView, L3LinkView, MACView, ObjectView, PortView, ProjectView, ScreenshotView, TaskView, WebSocketView, ReportsView, InterfaceView, PivotView]:  # для каждого класса api
