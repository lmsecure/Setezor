...
class WebSocketManager:
    ...
    async def connect(self, entity_id: str, websocket: WebSocket) -> None:
    ...
    def disconnect(self, entity_id: str, websocket: WebSocket) -> None:
    ...
    async def send_message(self, entity_id: str, message: WebSocketMessage) -> None:
