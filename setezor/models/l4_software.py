...
class L4Software(IDDependent, Base, table=True):
    ...
    dns_id: Optional[str] = Field(foreign_key="network_dns.id", sa_column_kwargs={"comment": "Идентификатор DNS записи"})
    ...
    dns: "DNS" = Relationship(back_populates="softwares") # type: ignore
