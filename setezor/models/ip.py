...
class IP(IDDependent, Base, table=True):
    ...
    interface_id: Optional[str]    = Field(foreign_key="setezor_agent_network_interface.id", sa_column_kwargs={"comment":"Идентификатор интерфейса"})
    ...
    dns_target: List["DNS"]             = Relationship(back_populates="target_ip") # type: ignore
